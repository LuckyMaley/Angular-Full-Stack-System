...
@Component({
  selector: 'app-sellers-products-update',
  templateUrl: './sellers-products-update.component.html',
  styleUrls: ['./sellers-products-update.component.css']
})
export class SellersProductsUpdateComponent  implements OnInit {
