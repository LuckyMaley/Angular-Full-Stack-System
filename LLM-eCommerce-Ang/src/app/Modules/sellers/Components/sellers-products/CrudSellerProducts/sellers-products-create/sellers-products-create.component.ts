...
@Component({
  selector: 'app-sellers-products-create',
  templateUrl: './sellers-products-create.component.html',
  styleUrls: ['./sellers-products-create.component.css']
})
export class SellersProductsCreateComponent implements OnInit {
