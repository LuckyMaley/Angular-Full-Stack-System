...
@Component({
  selector: 'app-admins-products-delete',
  templateUrl: './admins-products-delete.component.html',
  styleUrls: ['./admins-products-delete.component.css']
})
export class AdminsProductsDeleteComponent implements OnInit {
