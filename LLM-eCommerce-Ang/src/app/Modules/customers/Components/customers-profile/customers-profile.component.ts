...
import { Roles, UserAccountVM, UserAccountVMAdminSubmit, UserAccountVMSubmit, UserProfileVM } from 'src/app/Shared/Models/user-auth-vm';
...
export class CustomersProfileComponent implements OnInit{
  ...
  onSubmit(form: NgForm) {
    ...
    this.formModel.phoneNumber = form.value.phoneNumber;
      this.crudService.updateMyUserProfile(this.formModel).subscribe((data) => {
        alert(
